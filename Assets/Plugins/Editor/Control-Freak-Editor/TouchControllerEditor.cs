...
private void ResetCurrentStick()
	...
	//this.stick_layoutBoxIdProp.enumValueIndex	=(int)TouchController.LayoutBoxId.NONE;
	this.stick_layoutBoxIdProp.intValue		= 0; 
	//this.stick_shapeProp.enumValueIndex	= (int)TouchController.ControlShape.CIRCLE;
	...
	this.stick_stickVisProp.enumValueIndex			= (int)TouchStick.StickPosMode.FULL_ANALOG;
	...
	this.stick_getKeyCodePressProp.enumValueIndex	= (int)KeyCode.None;
	this.stick_getKeyCodePressAltProp.enumValueIndex= (int)KeyCode.None;
	this.stick_getKeyCodeUpProp.enumValueIndex		= (int)KeyCode.W;
	this.stick_getKeyCodeUpAltProp.enumValueIndex	= (int)KeyCode.UpArrow;
	this.stick_getKeyCodeDownProp.enumValueIndex	= (int)KeyCode.S;
	this.stick_getKeyCodeDownAltProp.enumValueIndex	= (int)KeyCode.DownArrow;
	this.stick_getKeyCodeLeftProp.enumValueIndex	= (int)KeyCode.A;
	this.stick_getKeyCodeLeftAltProp.enumValueIndex	= (int)KeyCode.LeftArrow;
	this.stick_getKeyCodeRightProp.enumValueIndex	= (int)KeyCode.D;
	this.stick_getKeyCodeRightAltProp.enumValueIndex= (int)KeyCode.RightArrow;
...
*/
	...
	//this.zone_layoutBoxIdProp.enumValueIndex	= (int)TouchController.LayoutBoxId.NONE;
	this.zone_layoutBoxIdProp.intValue	= 0;
	this.zone_shapeProp.enumValueIndex	= (int)TouchController.ControlShape.CIRCLE;
	...
	this.zone_getKeyCodeProp.enumValueIndex	= (int)KeyCode.None;
	this.zone_getKeyCodeAltProp.enumValueIndex	= (int)KeyCode.None;
	this.zone_getKeyCodeMultiProp.enumValueIndex = (int)KeyCode.None;
	this.zone_getKeyCodeMultiAltProp.enumValueIndex = (int)KeyCode.None;
...
//		this.SelectZone(this.zone_curId + 1);
	...
	if ((this.zone_prioProp != null) && (joy.touchZones != null) && 
		...
		if (this.zone_shapeProp.enumValueIndex != (int)TouchController.ControlShape.SCREEN_REGION)
			{
			...
			if (this.zone_shapeProp.enumValueIndex == (int)TouchController.ControlShape.CIRCLE)
				{
...
static private bool DrawEnumPopup(
	...
	int v = prop.enumValueIndex;
	if (label != null)
		EditorGUILayout.PropertyField(prop, new GUIContent(label, tooltip), guiOptions);
	else		
		EditorGUILayout.PropertyField(prop, guiOptions);

	return (v != prop.enumValueIndex);
	}
