...
private var fingerDownPosition : Vector2;

private var down_this_frame : boolean;
private var up_this_frame : boolean;
function Start()
{
...
function IsFingerFrameDown() : boolean
{
	return down_this_frame;
}


function IsFingerFrameUp() : boolean
{
